...
class ConfigManager:
    def __init__(self):
        ...
        self.VLLM_URL = self._get_config_or_env("VLLM_URL", str, "http://192.168.1.210:19000")
        self.MODEL_NAME = self._get_config_or_env("MODEL_NAME", str, "Qwen3Qoder")
...
async def main():
    ...
    task = "搜索 AH 股溢价，分析 AH 股溢价对当前市场情绪的影响"
